...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None, **kwargs):
    ...
    elif data_source in ["qwenvl_video_judge", "videoreward_qwenvl"]:
        from . import qwenvl_video_judge
        res = qwenvl_video_judge.compute_score(kwargs['prompt'], solution_str, ground_truth, extra_info)
    else:
        raise NotImplementedError
    return res
